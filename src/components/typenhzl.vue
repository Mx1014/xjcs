    ...
    methods: {
        ...
        setRight1(data) {
            ...
            var builderJson = {
                "all": all,
                "charts": {
                    ["今日"+{"电能":"电耗(kwh)","水能":"水耗(t)","气能":"气耗(m³)","油能":"油耗(L)"}[this.enType]]: data[2],
                    ["昨日"+{"电能":"电耗(kwh)","水能":"水耗(t)","气能":"气耗(m³)","油能":"油耗(L)"}[this.enType]]: data[1],
                    ["去年今日"+{"电能":"电耗(kwh)","水能":"水耗(t)","气能":"气耗(m³)","油能":"油耗(L)"}[this.enType]]:data[0]
                }
            };
