...
export default {
    ...
    methods: {
        ...
        getData(){
            this.$http.get("/Index/get_data_by_city_time",{params:{
                ...
                if(this.enType == "气能"||this.enType == "油能"){
                    res.data= {"elect_node_id":"1","cityname":"\u767e\u8272\u5e02","water_node_id":"30001","node_id":"1","title":"2018-01-04","energy_today":0,"energy_yesterday":0,"energy_lastyeartoday":0,"energy_today_list":{"name":"2018-01-04","data":[]},"energy_yesterday_list":{"name":"2018-01-03","data":[]},"energy_lastyeartoday_list":null,"energy_chartdata_list":[{"name":"2018-01-04","data":[]},{"name":"2018-01-03","data":[]}],"energy_department_energy_arr":[{"value":[]}]}
